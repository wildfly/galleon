...
public class PackageXmlParser30 implements PlugableXmlParser<PackageSpec.Builder> {
    ...
    public enum Element implements XmlNameProvider {
        ...
        static {
            ...
            elements.put(new QName(NAMESPACE_3_0, DEPENDENCIES.name), DEPENDENCIES);
            elements.put(new QName(NAMESPACE_3_0, PACKAGE_SPEC.name), PACKAGE_SPEC);
    ...
    public void readElement(XMLExtendedStreamReader reader, PackageSpec.Builder pkgBuilder) throws XMLStreamException {
        parseAttributes(reader, pkgBuilder);
    ...
    private void parseAttributes(final XMLExtendedStreamReader reader, PackageSpec.Builder pkgBuilder) throws XMLStreamException {
