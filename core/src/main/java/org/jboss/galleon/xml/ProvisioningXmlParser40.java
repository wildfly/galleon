 ...
 */
public class ProvisioningXmlParser40 implements PlugableXmlParser<ProvisioningConfig.Builder> {

    public static final String NAMESPACE = "urn:jboss:galleon:provisioning:4.0";
    ...
    enum Element implements XmlNameProvider {
        ...
        static {
            elementsByLocal = new HashMap<>(16);
    ...
    enum Attribute implements XmlNameProvider {
        ...
        static {
            ...
            attributes.put(ALLOWED_FAMILY.name, ALLOWED_FAMILY);
    ...
    private static void doReadFeaturePackDep(XMLExtendedStreamReader reader, FeaturePackDepsConfigBuilder<?> builder, boolean transitive)
        ...
        for (int i = 0; i < count; i++) {
            ...
            switch (attribute) {
                case LOCATION:
                    ...
                    break;
                case ALLOWED_FAMILY:
                    allowedFamily = reader.getAttributeValue(i);
                    break;
                default:
                    throw ParsingUtils.unexpectedContent(reader);
            }
        ...
        depBuilder.setAllowedFamily(allowedFamily);
        while (reader.hasNext()) {
            switch (reader.nextTag()) {
                case XMLStreamConstants.END_ELEMENT: {
                    try {
                ...
                case XMLStreamConstants.START_ELEMENT: {
                    ...
                    switch (element) {
                        ...
                        case ORIGIN:
                            ...
                            break;
                        case DEFAULT_CONFIGS:
                            ProvisioningXmlParser40.parseDefaultConfigs(reader, depBuilder);
                            break;
                        case CONFIG:
                            final ConfigModel.Builder config = ConfigModel.builder();
                            ConfigXml.readConfig(reader, config);
