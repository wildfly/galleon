 ...
 */
public class PackageXmlParser20 implements PlugableXmlParser<PackageSpec.Builder> {

    public static final String NAMESPACE_2_0 = "urn:jboss:galleon:package:2.0";
    public static final QName ROOT_2_0 = new QName(NAMESPACE_2_0, Element.PACKAGE_SPEC.getLocalName());
    ...
    public enum Element implements XmlNameProvider {
        ...
        static {
            ...
            elements.put(new QName(NAMESPACE_2_0, PACKAGE_SPEC.name), PACKAGE_SPEC);
