 ...
 * @author jfdenise
 */
public class FeaturePackSetDefaultStabilityTestCase extends AbstractFpStatibilityTestCase {
    ...
    protected ProvisionedState provisionedState() throws ProvisioningDescriptionException {
        return ProvisionedState.builder()
                ...
                .addFeaturePack(ProvisionedFeaturePack.builder(FP2_100_GAV).addPackage("fp2_1default").addPackage("fp2_2noStability").build())
                .build();
    }
}
