 ...
 */
public class IncludeDefaultPackagesOfFpDepTestCase extends PmProvisionConfigTestBase {
    ...
    private static final ChannelSpec FP3_GA = LegacyGalleon1Universe.newChannel("org.pm.test:fp3", "1");
