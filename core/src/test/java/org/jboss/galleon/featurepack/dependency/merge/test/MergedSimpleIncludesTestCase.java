 ...
 */
public class MergedSimpleIncludesTestCase extends PmProvisionConfigTestBase {
        ...
        creator
            ...
            .newFeaturePack(LegacyGalleon1Universe.newFPID("org.jboss.pm.test:fp2", "2", "2.0.0.Final"))
                .addDependency(FeaturePackConfig
                        .builder(LegacyGalleon1Universe.newFPID("org.jboss.pm.test:fp4", "2", "2.0.0.Final").getLocation())
                        .includePackage("p4")
                        .build())
                .newPackage("p1", true)
