 ...
 */
public class ModelOnModelDependencyTestCase extends ConfigOrderTestBase {
    ...
    protected ProvisioningConfig provisioningConfig() throws ProvisioningDescriptionException {
        return ProvisioningConfig.builder().addFeaturePackDep(FeaturePackConfig.forLocation(FP1_GAV.getLocation())).build();
    }
    ...
    protected ProvisionedState provisionedState() {
        return ProvisionedState.builder()
                ...
                .addConfig(ProvisionedConfigBuilder.builder()
                        ...
                        .addFeature(ProvisionedFeatureBuilder.builder(ResolvedFeatureId.create(new ResolvedSpecId(FP1_GAV.getChannel(),  "specA"), "id", "31")))
                        .build())
                .build();
    }
