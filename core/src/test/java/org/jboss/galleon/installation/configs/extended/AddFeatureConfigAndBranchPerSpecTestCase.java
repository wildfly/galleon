 ...
 */
public class AddFeatureConfigAndBranchPerSpecTestCase extends PmProvisionConfigTestBase {
    ...
    protected ProvisionedState provisionedState() {
        return ProvisionedState.builder()
                ...
                .addConfig(ProvisionedConfigBuilder.builder()
                        ...
                        .addFeature(ProvisionedFeatureBuilder.builder(ResolvedFeatureId.create(new ResolvedSpecId(FP1_GAV.getProducer(), "specA"), "id", "2")))
