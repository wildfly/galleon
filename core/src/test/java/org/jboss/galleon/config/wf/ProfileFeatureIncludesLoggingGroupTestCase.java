...
public class ProfileFeatureIncludesLoggingGroupTestCase extends PmInstallFeaturePackTestBase {
    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningException {
        ...
        .newFeaturePack(FP_GAV)
            ...
            .addFeatureSpec(FeatureSpec.builder("logger")
                    ...
                    .addFeatureRef(FeatureReferenceSpec.builder("logging").build())
                    .build())
    ...
    protected ProvisionedState provisionedState() throws ProvisioningException {
        ...
        .addFeature(ProvisionedFeatureBuilder.builder(ResolvedFeatureId.create(FP_GAV.getProducer(), "root-logger", "profile", "default"))
                ...
                .build())
        .addFeature(ProvisionedFeatureBuilder.builder(ResolvedFeatureId.create(FP_GAV.getProducer(), "root-logger", "profile", "ha"))
                .setConfigParam("level", "INFO")
                .setConfigParam("console-handler", "CONSOLE")
                .setConfigParam("periodic-rotating-file-handler", "FILE")
                .build())
