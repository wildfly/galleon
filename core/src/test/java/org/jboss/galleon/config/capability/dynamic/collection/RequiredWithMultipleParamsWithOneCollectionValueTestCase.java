 ...
 */
public class RequiredWithMultipleParamsWithOneCollectionValueTestCase extends PmInstallFeaturePackTestBase {
    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningException {
        ...
        .newFeaturePack(FP_GAV)
            .addFeatureSpec(FeatureSpec.builder("specA")
                    ...
                    .addParam(FeatureParameterSpec.builder("col").setType("List<String>").build())
    ...
    protected ProvisionedState provisionedState() throws ProvisioningException {
        return ProvisionedState.builder()
                ...
                .addConfig(ProvisionedConfigBuilder.builder()
                        ...
                        .addFeature(ProvisionedFeatureBuilder.builder(ResolvedFeatureId.create(FP_GAV.getProducer(), "specB", "b", "b1")).setConfigParam("p1", "a1").setConfigParam("p2", "[y, x]").setConfigParam("p3", "pi").build())
                        .build())
                .build();
    }
}
