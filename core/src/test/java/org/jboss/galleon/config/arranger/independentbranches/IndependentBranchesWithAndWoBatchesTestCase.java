 ...
 */
public class IndependentBranchesWithAndWoBatchesTestCase extends PmInstallFeaturePackTestBase {
    ...
    public static class ConfigHandler extends TestProvisionedConfigHandler {
        ...
        protected String[] initEvents() throws Exception {
            return new String[] {
                    ...
                    specEvent("specF"),
                    featureEvent(ResolvedFeatureId.builder(FP1_GAV.getProducer(), "specF").setParam("f", "1").build()),
                    specEvent("specA"),
    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningException {
        ...
        .newFeaturePack(FP1_GAV)
            ...
            .addFeatureSpec(FeatureSpec.builder("specD")
                    .addAnnotation(FeatureAnnotation.featureBranch("d", true))
                    .addParam(FeatureParameterSpec.createId("d"))
                    .build())
            .addFeatureSpec(FeatureSpec.builder("specE")
                    .addAnnotation(FeatureAnnotation.featureBranch("e", true))
            ...
            .addConfig(ConfigModel.builder()
                    ...
                    .addFeature(new FeatureConfig("specF").setParam("f", "1"))
