 ...
 */
public class ParentChildrenSpecBranchFalseBranchPerSpecNonBatchTestCase extends PmInstallFeaturePackTestBase {
    ...
    public static class ConfigHandler extends TestProvisionedConfigHandler {
        ...
        protected String[] initEvents() throws Exception {
            return new String[] {
                    ...
                    specEvent("specC"),
                    featureEvent(ResolvedFeatureId.builder(FP1_GAV, "specC").setParam("a", "2").setParam("b", "1").setParam("c", "1").build()),
                    specEvent("specD"),
                    featureEvent(ResolvedFeatureId.builder(FP1_GAV, "specD").setParam("a", "2").setParam("b", "1").setParam("c", "1").setParam("d", "1").build()),
                    branchEndEvent(),
