 ...
 */
public class CircularDepInTheMiddleOfFkBranchPerSpecTestCase extends PmInstallFeaturePackTestBase {
    ...
    public static class ConfigHandler extends TestProvisionedConfigHandler {
        ...
        protected String[] initEvents() throws Exception {
            return new String[] {
                    ...
                    branchStartEvent(),
                    specEvent("specA5"),
                    featureEvent(ResolvedFeatureId.builder(FP1_GAV.getProducer(), "specA5").setParam("a", "1").setParam("a5", "1").build()),
                    featureEvent(ResolvedFeatureId.builder(FP1_GAV.getProducer(), "specA5").setParam("a", "2").setParam("a5", "1").build()),
                    branchEndEvent()
            };
        }
    }
    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningException {
        ...
        .newFeaturePack(FP1_GAV)
            ...
            .addFeatureSpec(FeatureSpec.builder("specA")
                    ...
                    .build())
            .addFeatureSpec(FeatureSpec.builder("specA1")
                    .providesCapability("a1.$a.$a1")
                    .addFeatureRef(FeatureReferenceSpec.create("specA"))
                    .addFeatureRef(FeatureReferenceSpec.create("specA2"))
                    .addParam(FeatureParameterSpec.createId("a"))
                    .addParam(FeatureParameterSpec.createId("a1"))
                    .addParam(FeatureParameterSpec.create("a2"))
                    .build())
            .addFeatureSpec(FeatureSpec.builder("specA2")
                    .addFeatureRef(FeatureReferenceSpec.create("specA"))
                    .addFeatureRef(FeatureReferenceSpec.create("specA3"))
                    .addParam(FeatureParameterSpec.createId("a"))
                    .addParam(FeatureParameterSpec.createId("a2"))
                    .addParam(FeatureParameterSpec.create("a3"))
                    .build())
            .addFeatureSpec(FeatureSpec.builder("specA3")
                    ...
                    .build())
            .addFeatureSpec(FeatureSpec.builder("specA4")
                    .addFeatureRef(FeatureReferenceSpec.create("specA"))
                    .addParam(FeatureParameterSpec.createId("a"))
                    .addParam(FeatureParameterSpec.createId("a4"))
                    .build())
            .addFeatureSpec(FeatureSpec.builder("specA5")
                    .addFeatureRef(FeatureReferenceSpec.create("specA"))
                    .addFeatureRef(FeatureReferenceSpec.create("specA3"))
                    .addParam(FeatureParameterSpec.createId("a"))
                    .addParam(FeatureParameterSpec.createId("a5"))
                    .addParam(FeatureParameterSpec.create("a3"))
                    .build())
            ...
            .addConfig(ConfigModel.builder()
                    ...
                    .addFeature(new FeatureConfig("specA3").setParam("a", "1").setParam("a3", "1").setParam("a1", "1"))
                    .addFeature(new FeatureConfig("specA3").setParam("a", "2").setParam("a3", "1").setParam("a1", "1"))

                    .addFeature(new FeatureConfig("specA5").setParam("a", "1").setParam("a5", "1").setParam("a3", "1"))
                    .addFeature(new FeatureConfig("specA5").setParam("a", "2").setParam("a5", "1").setParam("a3", "1"))
                    ...
                    .addFeature(new FeatureConfig("specA1").setParam("a", "1").setParam("a1", "1").setParam("a2", "1"))
                    .addFeature(new FeatureConfig("specA1").setParam("a", "2").setParam("a1", "1").setParam("a2", "1"))
    ...
    protected ProvisionedState provisionedState() throws ProvisioningException {
        return ProvisionedState.builder()
                ...
                .addConfig(ProvisionedConfigBuilder.builder()
                        ...
                        .addFeature(ProvisionedFeatureBuilder.builder(ResolvedFeatureId.builder(FP1_GAV.getProducer(), "specA2").setParam("a", "1").setParam("a2", "1").build()).setConfigParam("a3", "1")
                                .build())
                        .addFeature(ProvisionedFeatureBuilder.builder(ResolvedFeatureId.builder(FP1_GAV.getProducer(), "specA1").setParam("a", "1").setParam("a1", "1").build()).setConfigParam("a2", "1")
                                .build())
                        .addFeature(ProvisionedFeatureBuilder.builder(ResolvedFeatureId.builder(FP1_GAV.getProducer(), "specA3").setParam("a", "1").setParam("a3", "1").build()).setConfigParam("a1", "1")
                                .build())

                        .addFeature(ProvisionedFeatureBuilder.builder(ResolvedFeatureId.builder(FP1_GAV.getProducer(), "specA2").setParam("a", "2").setParam("a2", "1").build()).setConfigParam("a3", "1")
                                .build())
                        .addFeature(ProvisionedFeatureBuilder.builder(ResolvedFeatureId.builder(FP1_GAV.getProducer(), "specA1").setParam("a", "2").setParam("a1", "1").build()).setConfigParam("a2", "1")
                                .build())
                        .addFeature(ProvisionedFeatureBuilder.builder(ResolvedFeatureId.builder(FP1_GAV.getProducer(), "specA3").setParam("a", "2").setParam("a3", "1").build()).setConfigParam("a1", "1")
                                .build())

                        .addFeature(ProvisionedFeatureBuilder.builder(ResolvedFeatureId.builder(FP1_GAV.getProducer(), "specA5").setParam("a", "1").setParam("a5", "1").build()).setConfigParam("a3", "1")
                                .build())
                        .addFeature(ProvisionedFeatureBuilder.builder(ResolvedFeatureId.builder(FP1_GAV.getProducer(), "specA5").setParam("a", "2").setParam("a5", "1").build()).setConfigParam("a3", "1")
                                .build()))
