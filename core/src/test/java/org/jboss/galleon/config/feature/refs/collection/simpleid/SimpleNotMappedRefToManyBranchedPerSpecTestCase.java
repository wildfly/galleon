 ...
 */
public class SimpleNotMappedRefToManyBranchedPerSpecTestCase extends PmInstallFeaturePackTestBase {
    ...
    protected ProvisionedState provisionedState() throws ProvisioningException {
        return ProvisionedState.builder()
                ...
                .addConfig(ProvisionedConfigBuilder.builder()
                        ...
                        .addFeature(ProvisionedFeatureBuilder.builder(ResolvedFeatureId.create(FP_GAV.getProducer(), "specA", "a", "a3")).build())
