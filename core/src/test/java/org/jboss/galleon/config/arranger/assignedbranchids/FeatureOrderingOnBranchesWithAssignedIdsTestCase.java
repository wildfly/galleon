 ...
 */
public class FeatureOrderingOnBranchesWithAssignedIdsTestCase extends PmInstallFeaturePackTestBase {
    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningException {
        ...
        .newFeaturePack(FP1_GAV)
            ...
            .addConfig(ConfigModel.builder()
                    .setName("main")
                    .addFeature(new FeatureConfig("specD").setParam("d", "1").setParam("requiredCap", "cap2"))
        ...
        return ProvisionedState.builder()
                ...
                .addConfig(ProvisionedConfigBuilder.builder()
                        ...
                        .addFeature(ProvisionedFeatureBuilder.builder(ResolvedFeatureId.builder(FP1_GAV.getProducer(), "specD")
                                .setParam("d", "1")
                                .build())
                                .setConfigParam("requiredCap", "cap2")
                                .build())
