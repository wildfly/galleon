 ...
 */
public class ParentChildrenBranchPerSpecFalseNonBatchTestCase extends PmInstallFeaturePackTestBase {
    ...
    public static class ConfigHandler extends TestProvisionedConfigHandler {
        ...
        protected String[] initEvents() throws Exception {
            return new String[] {
                    ...
                    specEvent("specC"),
                    featureEvent(ResolvedFeatureId.builder(FP1_GAV.getProducer(), "specC").setParam("a", "2").setParam("b", "1").setParam("c", "1").build()),
                    specEvent("specB"),
                    featureEvent(ResolvedFeatureId.builder(FP1_GAV.getProducer(), "specB").setParam("a", "2").setParam("b", "1").build()),
                    specEvent("specD"),
                    featureEvent(ResolvedFeatureId.builder(FP1_GAV.getProducer(), "specD").setParam("a", "2").setParam("b", "1").setParam("c", "1").setParam("d", "1").build()),
                    branchEndEvent()
            };
        }
    }
    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningException {
        ...
        .newFeaturePack(FP1_GAV)
            ...
            .addConfig(ConfigModel.builder()
                    ...
                    .addFeature(new FeatureConfig("specD").setParam("a", "2").setParam("b", "1").setParam("c", "1").setParam("d", "1"))
                    .addFeature(new FeatureConfig("specC").setParam("a", "2").setParam("b", "1").setParam("c", "1"))
