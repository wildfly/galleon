 ...
 * @author jfdenise
 */
public class FeatureNoStabilityTestCase extends AbstractFeatureStabilityTestCase {

    @Override
    protected ProvisioningConfig provisioningConfig() throws ProvisioningDescriptionException {
        return ProvisioningConfig.builder().
                addFeaturePackDep(FeaturePackConfig.builder(FP1_GAV.getLocation()).setInheritPackages(true).build()).
                addFeaturePackDep(FeaturePackConfig.builder(FP2_GAV.getLocation()).setInheritPackages(true).build()).build();
    }

    @Override
    protected ProvisionedState provisionedState() throws ProvisioningDescriptionException  {
        return ProvisionedState.builder()
                .addFeaturePack(ProvisionedFeaturePack.builder(FP1_GAV).addPackage("p").addPackage("pDefault").addPackage("pCommunity").addPackage("pPreview").addPackage("pExperimental").build())
                .addConfig(ProvisionedConfigBuilder.builder()
                        ...
                        .addFeature(ProvisionedFeatureBuilder.
                                builder(ResolvedFeatureId.builder(new ResolvedSpecId(FP1_GAV.getProducer(),  "specExperimental")).
