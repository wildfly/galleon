 ...
 */
public class FeatureSpecDependencyLoopTestCase extends PmInstallFeaturePackTestBase {
    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningException {
        ...
        .newFeaturePack(FP_GAV)
            .addFeatureSpec(FeatureSpec.builder("specA")
                    ...
                    .addFeatureDep(FeatureDependencySpec.create(FeatureId.create("specC", "id", "c"), false))
                    .build())
            .addFeatureSpec(FeatureSpec.builder("specB")
                    .addParam(FeatureParameterSpec.createId("id"))
                    .addParam(FeatureParameterSpec.create("b", true))
                    .addFeatureDep(FeatureDependencySpec.create(FeatureId.create("specA", "id", "a"), false))
                    .build())
            .addFeatureSpec(FeatureSpec.builder("specC")
                    .addParam(FeatureParameterSpec.createId("id"))
                    .addParam(FeatureParameterSpec.create("c", true))
                    .addFeatureDep(FeatureDependencySpec.create(FeatureId.create("specB", "id", "b"), false))
                    .build())
