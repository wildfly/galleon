 ...
 */
public class ConfigSimplePackageDependenciesTestCase extends PmInstallFeaturePackTestBase {
    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningException {
        ...
        .newFeaturePack(FP_GAV)
            ...
            .addConfig(ConfigModel.builder()
                    ...
                    .addPackageDep("config1.pkg")
                    .build())
            .newPackage("p1", true)
                .getFeaturePack()
            .newPackage("config1.pkg")
                .addDependency("p2")
                .getFeaturePack()
            .newPackage("p2")
                .getFeaturePack()
