 ...
 * @author jdenise
 */
public class StateFullPathCompleter implements OptionCompleter<PmCompleterInvocation>, GalleonCLICommandCompleter {
    ...
    public String getCoreCompleterClassName(PmSession session) {
        return "org.jboss.galleon.cli.cmd.state.core.CoreStateFullPathCompleter";
    }
