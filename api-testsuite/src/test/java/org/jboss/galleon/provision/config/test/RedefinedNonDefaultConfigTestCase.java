 ...
 */
public class RedefinedNonDefaultConfigTestCase extends ProvisionFromUniverseTestBase {
    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningException {
        ...
        .addConfig(ConfigModel.builder("model1", "name1")
                .addFeature(new FeatureConfig("specA").setParam("p1", "base")).build(), false)
    ...
    protected GalleonProvisioningConfig provisioningConfig() throws ProvisioningException {
        return GalleonProvisioningConfig.builder()
                .addFeaturePackDep(GalleonFeaturePackConfig.builder(topFp)
                        .setInheritConfigs(false)
                        .build())
                .addConfig(ConfigModel.builder("model1", "name1")
                        .addFeature(new FeatureConfig("specA").setParam("p1", "redefined"))
                        .build())
                .build();
    }
    ...
    protected ProvisionedState provisionedState() throws ProvisioningException {
        return ProvisionedState.builder()
                ...
                .addConfig(ProvisionedConfigBuilder.builder()
                        .setModel("model1")
                        .setName("name1")
                        .addFeature(ProvisionedFeatureBuilder.builder(ResolvedFeatureId.create(baseFp.getFPID().getProducer(), "specA", "p1", "redefined")))
                        .build())
                .build();
    }
}