 ...
 */
public class UniverseAliasInFeaturePackDepsTestCase extends ProvisionConfigMvnTestBase {

    private static final FeaturePackLocation FP1_FPL = FeaturePackLocation.fromString("producer1@universe1:1#1.0.0.Final");
    private static final FeaturePackLocation FP2_FPL = FeaturePackLocation.fromString("producer1@universe2:1#1.0.0.Final");
    private static final FeaturePackLocation FP3_FPL = FeaturePackLocation.fromString("producer2@universe2:1#1.0.0.Final");
    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningException {
        ...
        universe1Art = newMvnUniverse("universe1")
                ...
                .install();
        universe2Art = newMvnUniverse("universe2")
                .createProducer("producer1", "fp2")
                .createProducer("producer2", "fp3")
                .install();

        fp1Fpid = mvnFPID(FP1_FPL, universe1Art);
        fp2Fpid = mvnFPID(FP2_FPL, universe2Art);
        fp3Fpid = mvnFPID(FP3_FPL, universe2Art);

        creator
        .newFeaturePack()
            .setFPID(fp1Fpid)
            .addUniverse("universe2", MavenUniverseFactory.ID, universe2Art.getGaecv().toGaecRange())
