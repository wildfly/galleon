...
public class AdvancedFeaturePackFamilyFailingTestCase extends LayoutOrderingTestBase {
    ...
    protected String[] pmErrors() throws ProvisioningException {
        String[] errors = {"Some errors have been encountered processing feature-pack families.\n"+
                           "jboss-eap:jakarta-min-ee-10 is provided by more than 1 feature-pack [org.jboss.galleon.test:ee11:1.0.0.Final, org.jboss.galleon.test:ee10:1.0.0.Final].\n" +
                           "jboss-eap:jakarta-ee is provided by more than 1 feature-pack [org.jboss.galleon.test:ee11:1.0.0.Final, org.jboss.galleon.test:ee10:1.0.0.Final].\n" +
