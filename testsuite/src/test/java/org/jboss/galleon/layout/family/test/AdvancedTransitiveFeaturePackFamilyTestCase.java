...
public class AdvancedTransitiveFeaturePackFamilyTestCase extends FamilyLayoutOrderingTestBase {
    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningDescriptionException {
        ...
        builder3.addDependency(FeaturePackConfig.builder(fpl1, false, "family1:specific1").build());
    ...
    protected FPID[] expectedOrder() {
        return new FPID[]{fpl1.getFPID(), fpl3.getFPID(), fpl6.getFPID(), fpl7.getFPID()};
    }
