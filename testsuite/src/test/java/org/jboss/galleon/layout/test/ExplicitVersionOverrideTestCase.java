 ...
 */
public class ExplicitVersionOverrideTestCase extends ProvisioningLayoutTestBase {
    ...
    protected FPID[] expectedOrder() {
        return new FPID[] {fpl1_101.getFPID(), fpl2.getFPID()};
    }
}
