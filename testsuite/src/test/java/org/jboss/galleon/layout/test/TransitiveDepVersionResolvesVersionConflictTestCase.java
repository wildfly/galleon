 ...
 */
public class TransitiveDepVersionResolvesVersionConflictTestCase extends ProvisioningLayoutTestBase {
    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningDescriptionException {
        ...
        creator.newFeaturePack(fpl3.getFPID()).addDependency(fpl1_102);
    }
    ...
    protected FPID[] expectedOrder() {
        return new FPID[] {fpl1_100.getFPID(), fpl2.getFPID(), fpl3.getFPID()};
    }
}
