...
public class FeaturePackMultipleFamilyOverridesTestCase extends FamilyLayoutOrderingTestBase {
    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningDescriptionException {
        ...
        builder1.setFamily(Family.fromString("family1:specificity1"));
        ...
        builder2.setFamily(Family.fromString("family1:specificity1"));
        ...
        builder3.addDependency(FeaturePackConfig.builder(fpl1, false, "family1:specificity1").build());
    }
