...
public class SquashDepFeaturePackPackagesFamilyTestCase extends ProvisionFromUniverseTestBase {
    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningDescriptionException {
        ...
        builder3.addDependency("orig1", FeaturePackConfig.builder(ee).setAllowedFamily("wildfly:jakarta-ee+jakarta-min-ee-10").build());
