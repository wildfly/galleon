...
public class Advanced2FeaturePackFamilyTestCase extends FamilyLayoutOrderingTestBase {
    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningDescriptionException {
        ...
        builder1.setFamily(Family.fromString("wildfly:jakarta-ee,jakarta-ee-10+,jakarta-ee10"));
        ...
        builder2.setFamily(Family.fromString("wildfly:jakarta-ee,jakarta-ee-10+,jakarta-ee11"));
        ...
        builder5.addDependency(FeaturePackConfig.builder(ee10, false, "wildfly:jakarta-ee,jakarta-ee-10+").build());
