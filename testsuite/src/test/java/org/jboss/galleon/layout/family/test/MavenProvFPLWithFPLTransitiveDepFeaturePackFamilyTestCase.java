...
public class MavenProvFPLWithFPLTransitiveDepFeaturePackFamilyTestCase extends FamilyLayoutOrderingTestBase {
    ...
    protected ProvisioningConfig provisioningConfig() throws ProvisioningException {
        return ProvisioningConfig.builder()
                .addFeaturePackDep(toMavenCoordsFpl(ee10))
                .addFeaturePackDep(toMavenCoordsFpl(full))
                .addFeaturePackDep(toMavenCoordsFpl(grpc)).build();
    }
