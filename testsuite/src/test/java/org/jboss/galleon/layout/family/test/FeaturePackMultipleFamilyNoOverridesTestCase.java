...
public class FeaturePackMultipleFamilyNoOverridesTestCase extends FamilyLayoutOrderingTestBase {
    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningDescriptionException {
        ...
        builder3.addDependency(FeaturePackConfig.builder(fpl1, false, "family1:specificity2").build());
    }
    ...
    protected FPID[] expectedOrder() {
        return new FPID[]{fpl2.getFPID(), fpl1.getFPID(), fpl3.getFPID()};
    }
