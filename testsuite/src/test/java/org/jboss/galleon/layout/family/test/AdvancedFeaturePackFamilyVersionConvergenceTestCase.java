...
public class AdvancedFeaturePackFamilyVersionConvergenceTestCase extends FamilyLayoutOrderingTestBase {
    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningDescriptionException {
        // No family, version convergence in place
        ...
        // No family, version convergence in place
        fpl2 = FeaturePackLocation.fromString("org.jboss.galleon.test:dep-family1-fp1:2.0.0.Final");
        ...
        builder4.addDependency(FeaturePackConfig.builder(fpl2).build());
    ...
    protected FPID[] expectedOrder() {
        return new FPID[]{fpl1.getFPID(), fpl4.getFPID(), fpl6.getFPID(), fpl7.getFPID()};
    }
