...
public class FeaturePackFamilySameProducerDiffCriteriaTestCase extends FamilyLayoutOrderingTestBase {
    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningDescriptionException {
        ...
        builder1.setFamily(Family.fromString("family1:jakarta-ee-10,jakarta-ee-10+"));

        fpl2 = FeaturePackLocation.fromString("org.jboss.galleon.test:dep-family-fp1:2.0.0.Final");
        FeaturePackBuilder builder2 = creator.newFeaturePack(fpl2.getFPID());
        builder2.setFamily(Family.fromString("family1:jakarta-ee-11,jakarta-ee-10+"));
        ...
        builder3.addDependency(FeaturePackConfig.builder(fpl1, false, "family1:jakarta-ee-10+").build());
    }
    ...
    protected FPID[] expectedOrder() {
        return new FPID[]{fpl2.getFPID(), fpl3.getFPID()};
    }
