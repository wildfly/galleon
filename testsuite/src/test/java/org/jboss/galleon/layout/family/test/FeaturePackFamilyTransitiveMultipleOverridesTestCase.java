...
public class FeaturePackFamilyTransitiveMultipleOverridesTestCase extends FamilyLayoutOrderingTestBase {
    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningDescriptionException {
        ...
        builder5.addDependency(FeaturePackConfig.builder(fpl1, false, "family1:specific1").build())
                .addDependency(FeaturePackConfig.builder(fpl3, false, "family1:specific2").build());

        fpl6 = FeaturePackLocation.fromString("org.jboss.galleon.test:fp2:1.0.0.Final");
        FeaturePackBuilder builder6 = creator.newFeaturePack(fpl6.getFPID());
        builder6.addDependency(FeaturePackConfig.builder(fpl2, false, "family1:specific1").build())
                .addDependency(FeaturePackConfig.builder(fpl4, false, "family1:specific2").build());
    }

    @Override
    protected ProvisioningConfig provisioningConfig() throws ProvisioningException {
        return ProvisioningConfig.builder()
                .addFeaturePackDep(fpl5)
                .addFeaturePackDep(fpl6).build();
    }

    @Override
    protected FPID[] expectedOrder() {
        return new FPID[]{fpl1.getFPID(), fpl3.getFPID(), fpl5.getFPID(), fpl6.getFPID()};
    }
