...
public class FeaturePackFamilyTransitiveOverridesTestCase extends FamilyLayoutOrderingTestBase {
    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningDescriptionException {
        ...
        builder3.addDependency(FeaturePackConfig.builder(fpl2).build());
        ...
        builder4.addDependency(FeaturePackConfig.builder(fpl1, false, "family1:specific1").build());
    }
    ...
    protected FPID[] expectedOrder() {
        return new FPID[]{fpl2.getFPID(), fpl3.getFPID(), fpl4.getFPID()};
    }
