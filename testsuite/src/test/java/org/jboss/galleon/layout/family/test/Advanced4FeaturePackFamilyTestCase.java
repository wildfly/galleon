...
public class Advanced4FeaturePackFamilyTestCase extends FamilyLayoutOrderingTestBase {
    ...
    protected FPID[] expectedOrder() {
        return new FPID[]{ee10.getFPID(), xpee10.getFPID(), cloud.getFPID(), cloudxp.getFPID()};
    }
