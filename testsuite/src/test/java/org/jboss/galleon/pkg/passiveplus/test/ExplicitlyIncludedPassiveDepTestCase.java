 ...
 */
public class ExplicitlyIncludedPassiveDepTestCase extends ProvisionFromUniverseTestBase {
    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningException {
        ...
        creator.newFeaturePack()
            ...
            .newPackage("p4")
                .getFeaturePack()
            .newPackage("p5")
                .addDependency("p6", true)
                .addDependency("p7")
                .addDependency(PackageDependencySpec.passive("p8"))
                .addDependency(PackageDependencySpec.passive("p9"))
                .getFeaturePack()
            .newPackage("p6")
                .getFeaturePack()
            .newPackage("p7")
