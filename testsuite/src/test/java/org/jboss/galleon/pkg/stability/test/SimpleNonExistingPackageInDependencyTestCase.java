...
/**
 * A test for a reference to a package that is not included in the fp this fp depends on.
 *
 * @author jfdenise
 */
public class SimpleNonExistingPackageInDependencyTestCase extends ProvisionFromUniverseTestBase {
    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningException {
        ...
        creator.newFeaturePack()
                ...
                .addDependency("fp1", prod1)
                .addConfigLayer(ConfigLayerSpec.builder().setModel("model1").setName("layerA")
                        .addPackageDep("fp1", PackageDependencySpec.required("p1"))
                        .addPackageDep("fp1", PackageDependencySpec.optional("p2", Constants.STABILITY_EXPERIMENTAL))
                        .addPackageDep("fp1", PackageDependencySpec.passive("p3", Constants.STABILITY_COMMUNITY))
                        .build())
