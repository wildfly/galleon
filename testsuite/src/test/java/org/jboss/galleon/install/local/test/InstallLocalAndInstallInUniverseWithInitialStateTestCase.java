 ...
 */
public class InstallLocalAndInstallInUniverseWithInitialStateTestCase extends InstallLocalTestBase {
    ...
    protected ProvisioningConfig provisionedConfig() throws ProvisioningDescriptionException {
        return ProvisioningConfig.builder().addFeaturePackDep(fp1).addFeaturePackDep(fp2).build();
    }
