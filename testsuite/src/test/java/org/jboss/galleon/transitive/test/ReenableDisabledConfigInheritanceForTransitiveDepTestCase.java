 ...
 */
public class ReenableDisabledConfigInheritanceForTransitiveDepTestCase extends ProvisionFromUniverseTestBase {
    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningException {
        ...
        .addConfig(ConfigModel.builder("model1", "name1")
                .addFeature(new FeatureConfig("specA").setParam("p1", "1")).build(), false)
