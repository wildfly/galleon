 ...
 */
public class TransitiveDepVersionOverrideWithDisabledConfigsTestCase extends ProvisionFromUniverseTestBase {

    private FeaturePackLocation fp1;
    private FeaturePackLocation fp20;
    private FeaturePackLocation fp21;
    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningException {
        ...
        creator.newFeaturePack()
            .setFPID(fp1.getFPID())
            .addDependency("fp2", FeaturePackConfig.builder(fp20).build())
        ...
        creator.newFeaturePack()
            ...
            .newPackage("p1", true)
                ...
                .getFeaturePack()
            .newPackage("p2", false)
                .writeContent("fp2/p2.txt", "fp20");

        creator.newFeaturePack()
            .setFPID(fp21.getFPID())
            .addFeatureSpec(FeatureSpec.builder("specB")
                .addParam(FeatureParameterSpec.createId("p1"))
                .build())
            .addConfig(ConfigModel.builder("model1", "name1")
                .addFeature(new FeatureConfig("specB").setParam("p1", "21"))
                .build())
            .newPackage("p1", true)
                .writeContent("fp2/p1.txt", "fp21")
                .getFeaturePack()
            .newPackage("p2", false)
    ...
    protected ProvisioningConfig provisioningConfig() throws ProvisioningException {
        return ProvisioningConfig.builder()
                .addFeaturePackDep(FeaturePackConfig.transitiveBuilder(fp21)
    ...
    protected ProvisionedState provisionedState() throws ProvisioningException {
        return ProvisionedState.builder()
                .addFeaturePack(ProvisionedFeaturePack.builder(fp21.getFPID())
                        .addPackage("p2")
                        .build())
