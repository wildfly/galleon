 ...
 */
public class ConfigIncludeExcludeInheritConfigsFalseIncludeModelTestCase extends PersistChangesTestBase {
    ...
    protected void testPm(ProvisioningManager pm) throws ProvisioningException {
        pm.provision(ProvisioningConfig.builder()
                ...
                .build());
        recursiveDelete("configs/model1/name1");
    ...
    protected ProvisionedConfig[] provisionedConfigModels() throws ProvisioningException {
        return new ProvisionedConfig[] {
                ...
                .setModel("model1")
                .setName("name2")
                .addFeature(ProvisionedFeatureBuilder.builder(ResolvedFeatureId.create(prod1.getProducer(), "specA", "id", "2"))
