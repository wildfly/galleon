 ...
 */
public class BasicWriteStateHistoryLimitTestCase extends SingleUniverseTestBase {
    ...
    protected void testPm(ProvisioningManager pm) throws ProvisioningException {
        ...
        pm.setStateHistoryLimit(3);
        assertFalse(pm.isUndoAvailable());
        assertEquals(3, pm.getStateHistoryLimit());
    }
