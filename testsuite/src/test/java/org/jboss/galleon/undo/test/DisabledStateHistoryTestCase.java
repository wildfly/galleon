 ...
 */
public class DisabledStateHistoryTestCase extends SingleUniverseTestBase {
    ...
    protected ProvisionedState provisionedState() throws ProvisioningException {
        return ProvisionedState.builder()
                .addFeaturePack(ProvisionedFeaturePack.builder(fp104.getFPID())
                        .addPackage("p1")
                        .build())
                .build();
    }
