 ...
 */
public class ExcludeNonExistingConfigLayerIgnoreNotExcludedLayersTestCase extends ProvisionFromUniverseTestBase {
    ...
    protected ProvisioningConfig provisioningConfig() throws ProvisioningException {
        return ProvisioningConfig.builder()
                ...
                .addConfig(ConfigModel.builder("model1", "name1")
                        ...
                        .excludeLayer("base")
                        .excludeLayer("other")
                        .includeFeature(FeatureId.create("specA", "id", "base-prod2"), new FeatureConfig().setParam("p3", "config"))
                        .build())
        ...
        return ProvisionedState.builder()
                ...
                .addConfig(ProvisionedConfigBuilder.builder()
                        ...
                        .addFeature(ProvisionedFeatureBuilder.builder(
                                ResolvedFeatureId.builder(prod1.getProducer(), "specA").setParam("id", "base-prod2").build())
