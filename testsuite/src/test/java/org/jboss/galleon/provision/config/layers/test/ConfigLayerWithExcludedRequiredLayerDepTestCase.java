 ...
 */
public class ConfigLayerWithExcludedRequiredLayerDepTestCase extends ProvisionFromUniverseTestBase {
    ...
    protected String[] pmErrors() {
        return new String[] {Errors.unsatisfiedLayerDependency("main", "base")};
    }
}