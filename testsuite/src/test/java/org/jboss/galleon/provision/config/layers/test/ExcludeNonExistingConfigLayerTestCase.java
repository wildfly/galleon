 ...
 */
public class ExcludeNonExistingConfigLayerTestCase extends ProvisionFromUniverseTestBase {
    ...
    protected String[] pmErrors() {
        return new String[] {
                Errors.excludedLayersWouldNotOtherwiseBeInstalled(new ConfigId("model1", "name1"), Arrays.asList("other"))
        };
    }
}