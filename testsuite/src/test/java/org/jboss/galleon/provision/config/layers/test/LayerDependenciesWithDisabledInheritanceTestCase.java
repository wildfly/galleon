 ...
 */
public class LayerDependenciesWithDisabledInheritanceTestCase extends ProvisionFromUniverseTestBase {
    ...
    protected ProvisionedState provisionedState() throws ProvisioningException {
        return ProvisionedState.builder()
                ...
                .addConfig(ProvisionedConfigBuilder.builder()
                        ...
                        .addLayer("model1", "a")
                        .addFeature(ProvisionedFeatureBuilder.builder(ResolvedFeatureId.create(prod1.getProducer(), "specA", "id", "base"))
                                .setConfigParam("p1", "spec")
                                .setConfigParam("p2", "spec")
                                .setConfigParam("p3", "spec"))
                        .addFeature(ProvisionedFeatureBuilder.builder(ResolvedFeatureId.create(prod1.getProducer(), "specA", "id", "a"))
                                .setConfigParam("p1", "spec")
                                .setConfigParam("p2", "spec")
                                .setConfigParam("p3", "spec"))
                        .build())
