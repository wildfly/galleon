 ...
 */
public class InstallTransitiveInExistingDirPlanTestCase extends ProvisioningPlanTestBase {
    ...
    protected ProvisioningPlan getPlan() throws ProvisioningDescriptionException {
        return ProvisioningPlan.builder()
                .install(FeaturePackConfig.transitiveBuilder(a100)
    ...
    protected ProvisioningConfig provisionedConfig() throws ProvisioningException {
        return ProvisioningConfig.builder()
                .addFeaturePackDep(FeaturePackConfig.transitiveBuilder(a100)
                        .setInheritConfigs(false)
                        .build())
                .addFeaturePackDep(c100)
                .build();
