 ...
 */
@GroupCommandDefinition(description = "", name = "packages", groupCommands = {
    StateExcludePackageCommand.class, StateIncludePackageCommand.class,
    StateRemoveExcludedPackageCommand.class, StateRemoveIncludedPackageCommand.class}, activator = FPDependentCommandActivator.class)
