 ...
 */
@GroupCommandDefinition(description = HelpDescriptions.FILESYSTEM, name = "filesystem",
        groupCommands = {CdCommand.class, Ls.class, Pwd.class})
public class FileSystemCommand implements PmGroupCommand {
