...
public interface HelpDescriptions {
    ...
    String MVN_SET_DEFAULT_RELEASE_POLICY = "Set the default release update policy. Without an argument value reset to default policy";
    String MVN_SET_DEFAULT_SNAPSHOT_POLICY = "Set the default snapshot update policy. Without an argument value reset to default policy";
    String MVN_ENABLE_RELEASE = "Enable or disable 'release' artifacts resolution. Without an argument value reset to default value";
    String MVN_ENABLE_SNAPSHOT = "Enable or disable 'snapshot' artifacts resolution. Without an argument value reset to default value";
